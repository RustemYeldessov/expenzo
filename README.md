...
**Tenge Cash** — это веб-приложение для управления личными финансами, написанное на Django. Проект помогает отслеживать расходы, классифицировать их по категориям и анализировать свои траты.
